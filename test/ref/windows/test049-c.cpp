...
int test049_StringSet_begin_const(test049_StringSet_t const* _this, test049_StringSetIterator_t** _result) {
    *_result = new bbl::detail::argument_type<void (std::set<std::string>)>::type::iterator(_this->begin());
    return 0;
}

int test049_StringSet_end_const(test049_StringSet_t const* _this, test049_StringSetIterator_t** _result) {
    *_result = new bbl::detail::argument_type<void (std::set<std::string>)>::type::iterator(_this->end());
    return 0;
}

int test049_StringSet_begin(test049_StringSet_t* _this, test049_StringSetIterator_t** _result) {
    *_result = new bbl::detail::argument_type<void (std::set<std::string>)>::type::iterator(_this->begin());
    return 0;
}

int test049_StringSet_end(test049_StringSet_t* _this, test049_StringSetIterator_t** _result) {
    *_result = new bbl::detail::argument_type<void (std::set<std::string>)>::type::iterator(_this->end());
    return 0;
}

int test049_StringSet_find_const(test049_StringSet_t const* _this, test049_String_t const* _Keyval, test049_StringSetIterator_t** _result) {
    try {
        *_result = new bbl::detail::argument_type<void (std::set<std::string>)>::type::iterator(_this->find(*_Keyval));
        return 0;
...
int test049_StringSet_find(test049_StringSet_t* _this, test049_String_t const* _Keyval, test049_StringSetIterator_t** _result) {
    try {
        *_result = new bbl::detail::argument_type<void (std::set<std::string>)>::type::iterator(_this->find(*_Keyval));
        return 0;
    } catch (std::exception& e) {
...
int test049_StringSetIterator_op_eq(test049_StringSetIterator_t const* _this, test049_StringSetIterator_t const* _Right, bool* _result) {
    *_result = _this->operator==(*_Right);
    return 0;
}
